...
Timed sends remain in the public PTP epoch-nanosecond domain; when the mlx5
MTUTC register selects the internal timer, DAQIRI maps the target to HCA cycles
before constructing the WAIT WQE.
