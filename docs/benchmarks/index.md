...
|---|---|---|---|
| Ingest from or egress to a programmable PCIe sensor, such as an FPGA or frame grabber on the PCIe bus. | `stream_type: "pcie"` | `daqiri_bench_pcie` | [PCIe / GPUDirect Benchmarking](pcie_benchmarking.md) |
