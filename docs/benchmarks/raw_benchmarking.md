...
!!! tip "DGX Spark"
    ...
    For the multi-queue core-scaling matrix, use the four `(TX, RX)` core-count configs — [`daqiri_bench_raw_tx_rx_spark_mq_1t1r.yaml`](https://github.com/nvidia/daqiri/blob/main/examples/daqiri_bench_raw_tx_rx_spark_mq_1t1r.yaml), [`daqiri_bench_raw_tx_rx_spark_mq_1t2r.yaml`](https://github.com/nvidia/daqiri/blob/main/examples/daqiri_bench_raw_tx_rx_spark_mq_1t2r.yaml), [`daqiri_bench_raw_tx_rx_spark_mq_2t1r.yaml`](https://github.com/nvidia/daqiri/blob/main/examples/daqiri_bench_raw_tx_rx_spark_mq_2t1r.yaml), [`daqiri_bench_raw_tx_rx_spark_mq_2t2r.yaml`](https://github.com/nvidia/daqiri/blob/main/examples/daqiri_bench_raw_tx_rx_spark_mq_2t2r.yaml) — with `daqiri_bench_raw_gpudirect`, driven by [`run_spark_mq_bench.sh`](https://github.com/nvidia/daqiri/blob/main/examples/run_spark_mq_bench.sh) for the payload sweep.
