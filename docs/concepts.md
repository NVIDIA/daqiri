...
directly to `set_packet_tx_time()`. On mlx5 devices operating in internal-timer
mode, DAQIRI converts that value to the free-running HCA counter before emitting
the WAIT WQE.
