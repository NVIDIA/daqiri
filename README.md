...
- [Configuration Generation](https://nvidia.github.io/daqiri/config-generation/) — Deterministic production/benchmark configs, schema validation, and cross-host role generation
