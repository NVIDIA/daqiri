...
- [Configuration Generation](https://nvidia.github.io/daqiri/config-generation/) — Deterministic production/benchmark configs, runtime validation, and cross-host role generation
