...
| `daqiri_repro_accurate_send_frame` | `accurate_send_frame_repro.cpp` | `daqiri_repro_accurate_send_frame.yaml` — 60 Hz framed WAIT+SEND reproduction with 4,320 two-segment packets/frame and hardware RX timestamp CSV; `daqiri_repro_accurate_send_frame_inline64.yaml` retains the cadence with 64-byte host packets embedded in SEND WQEs |
