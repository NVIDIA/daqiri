...
- `docs/daqiri-api.html` — legacy hand-maintained HTML C++ API page; not linked from the main API docs
...
- **Public API include** (`#include <daqiri/daqiri.h>`; source files under `include/daqiri/`) — `docs/api-reference/index.md`, `docs/api-reference/cpp.md`
