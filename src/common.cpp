...
#include "src/managed_burst_internal.h"
...
void shutdown() {
  ASSERT_DAQIRI_ENGINE_INITIALIZED();
  managed_burst_runtime_shutdown();
 ...
 * @return true if parsing was successful, false otherwise.
 */
bool YAML::convert<daqiri::NetworkConfig>::parse_tx_queue_common_config(const YAML::Node& q_item,
