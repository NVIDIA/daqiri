...
You can set the MTU for each interface like so, for a given `if_name` name identified [above](system_requirements.md#configure-the-ip-addresses-of-the-nic-ports):
...
=== "Persistent"
    ...
    === "systemd-networkd"
        ...
        Assuming you've set an IP address for the interface [above](system_requirements.md#configure-the-ip-addresses-of-the-nic-ports), you can add the MTU to the interface's network configuration file like so:
...
---
**Previous:** [System Requirements](system_requirements.md)  
