...
run_cell() {
  ...
  # Preserve the published sweep methodology: payload varies, while every
  # packet buffer retains the original base configuration's 8064-byte capacity.
  if ! python3 "$CONFIG_GEN" raw-pair \
        ...
        --batch-size 10240 --num-bufs 51200 \
